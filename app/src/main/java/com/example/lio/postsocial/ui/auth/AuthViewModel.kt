...
import com.example.lio.postsocial.other.Constants.MAX_USERNAME_LENGTH
import com.example.lio.postsocial.other.Constants.MIN_PASSWORD_LENGTH
import com.example.lio.postsocial.other.Constants.MIN_USERNAME_LENGTH
...
class AuthViewModel @ViewModelInject constructor(
    ...
    fun register(email: String, username:String, password: String, repeatedPassword: String) {
        val error = if (email.isEmpty() || username.isEmpty() || password.isEmpty()) {
            ...
            applicationContext.getString(R.string.error_password_too_short, MIN_USERNAME_LENGTH)
