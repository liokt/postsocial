package com.example.lio.postsocial.ui.main.dialogs
...
import com.example.lio.postsocial.adapters.CommentAdapter
import com.example.lio.postsocial.other.EventObserver
import com.example.lio.postsocial.ui.main.viewmodels.CommentViewModel
...
class CommentsDialog : DialogFragment() {
    ...
    private val args: CommentsDialogArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commentAdapter.setOnUserClickListener { comment ->
            ...
            findNavController().navigate(
                CommentsDialogDirections.globalActionToOthersProfileFragment(comment.uid)
            )
        }
    }
